...
import { addCars, editCarsInfo, deleteCarsInfo } from '../../actions/carsActions'
...
function TableCars () {
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    dispatch(addCars({ number, model, responsible }))
    setNumber('')
    setModel('')
    setResponsible('')
  ...
  const deleteHandler = (id) => {
    dispatch(deleteCarsInfo(id))
  }

  const submitUpdateHandler = (e) => {
    e.preventDefault()
    alert('Редактировать')
    dispatch(editCarsInfo({
      numberToUpdate,
      number: editNumber,
      model: editModel,
        ...
        <div className="card-body">
          <div className="tab-content" id="pills-tabContent">
            <div className="tab-pane fade show active" id="pills-home1" role="tabpanel" aria-labelledby="pills-home-tab1">
              <h2 className='text-center' style={{ color: '#2ca1c3' }}>Автомашины</h2>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                >
                  ...
                  <div className="mb-3">
                    <label htmlFor="recipient-name" className="directory-h5 col-form-label"><h6>Номер Aвтомобиля:</h6></label>
                    <input
                      type="text"
                  ...
                  <div className="mb-3">
                    <label htmlFor="recipient-name" className="directory-h5 col-form-label"><h6>Модель:</h6></label>
                    <input
                      type="text"
                      className="form-control"
                      id="recipient-name"
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                >
                  ...
                  <div className="mb-3">
                    <label htmlFor="recipient-name" className="directory-h5 col-form-label"><h6>Номер Автомобиля:</h6></label>
                    <input
                      type="text"
                      className="form-control"
                      id="recipient-name"
